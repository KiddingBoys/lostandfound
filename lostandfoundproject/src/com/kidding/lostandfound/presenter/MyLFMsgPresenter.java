 ...
 * @date 创建时间：2016-5-9 下午8:34:33 
 * @version 1.0 
 * @parameter   
 * @return 
 */
public class MyLFMsgPresenter {
	...
	public MyLFMsgPresenter(Context context, ILFMsgListView iLSthView) {
		this.context = context;
		this.iLSthView = iLSthView;
	}

	/**
	 * 获取MYMessageList(我的寻物帖/招领帖)
	 * @param isRefresh
	 */
	public void getLFMessage(final boolean isRefresh,String type) {
		if (isRefresh) {
			page = 0;
		}
		...
		params = "{name:"+SPHelper.instance(context).getString("userName")
				+",pageNo:" + page + ",pageCnt:" + number + ",type:"+type+"}";
		try {
