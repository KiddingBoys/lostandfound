 ...
 * @date 创建时间：2016-5-10 下午2:34:47 
 * @version 1.0 
 * @parameter   
 * @return 
 */
public class MainRefreshableView extends LinearLayout {
...
//	private final int ROTATE_ANIM_DURATION = 90;
    ...
    public MainRefreshableView(Context context) {
        super(context);
        mContext = context;
        
    }
    public MainRefreshableView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    ...
    private void init() {
        ...
        //刷新视图顶端的的view
         refreshView = LayoutInflater.from(mContext).inflate(R.layout.reflash_main_top_item, null);
        //指示器view
      //   refreshIndicatorView = (ImageView) refreshView.findViewById(R.id.indicator);
        ...
        downTextString = "下拉可刷新";
        releaseTextString = "松开可刷新";   
