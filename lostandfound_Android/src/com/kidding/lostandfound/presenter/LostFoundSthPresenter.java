 ...
 * @date 创建时间：2016-5-8 下午1:07:50
 * @version 1.0
 * @parameter
 * @return
 */
public class LostFoundSthPresenter {
	...
	public LostFoundSthPresenter(Context context, ILFMsgListView iLSthView) {
		this.context = context;
		this.iLSthView = iLSthView;
	}

	/**
	 * 获取MessageList(寻物帖/招领帖)
	 * @param isRefresh
	 */
	public void getLFMessage(final boolean isRefresh,String type) {
		...
		params = "{pageNo:" + page + ",pageCnt:" + number + ",type:"+type+"}";
		try {
