 ...
 * @date 创建时间：2016-5-4 下午7:53:33
 * @version 1.0
 * @parameter
 * @return
 */
public class FoundSthFragment extends Fragment implements ILFMsgListView,
		IXListViewListener {
	...
	@ViewInject(R.id.lv_found_sth_list)
	private XListView sthLv;
	final private String type = "found";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = (View) inflater.inflate(R.layout.fragment_found, container,
				false);
