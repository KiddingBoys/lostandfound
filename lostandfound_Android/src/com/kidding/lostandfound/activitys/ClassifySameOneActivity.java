...
import com.kidding.lostandfound.presenter.ClassifySameOnePresenter;
 ...
 * @date 创建时间：2016-5-9 下午8:29:24 
 * @version 1.0 
 * @parameter   
 * @return 
 */
public class ClassifySameOneActivity extends BaseActivity implements ILFMsgListView,
IXListViewListener{
	...
	private ClassifySameOnePresenter classifyPresenter;
	...
	private void init(){
		...
		classifyPresenter = new ClassifySameOnePresenter(this, this);
		...
		// 初次加载
		isReFlashFlag = true;
		classifyPresenter.getLFMessage(isReFlashFlag,category);
	}
